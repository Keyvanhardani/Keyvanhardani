...
focusing on AI security, autonomous perception systems, and neuromorphic computing.
...
- 🧠 Research Interests:  
  AI Security • Deep Learning (CNN, LSTM, TCN) • Spiking Neural Networks • Reinforcement Learning  
  Neuromorphic Vision • Embedded Systems • Automotive AI  

- 🧰 Tech Stack:  
  Python • C++ • TensorFlow • PyTorch • MATLAB • LangChain • Docker  

- 🔭 Currently working on:  
  - *AI Threat Detection and Autonomous Learning Systems*  
  - *Event-based Neuromorphic Vision & Secure Perception Models*

- 📫 Contact:  
  ✉️ [hardani@hotmail.de](mailto:hardani@hotmail.de)  
  🌐 [keyvan.ai](https://keyvan.ai)  
  🧬 [HuggingFace](https://huggingface.co/Keyven) | [Google Scholar](https://scholar.google.com/citations?user=ttXn0d0AAAAJ&hl=en) | [ResearchGate](https://www.researchgate.net/profile/Keyvan-Hardani)
